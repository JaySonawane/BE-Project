...
const Register = () => {
    ...
    const onClickRegister = async (event) => {
        ...
        if (user.role === 'farmer') {
          url = 'http://localhost:5000/farmerSignup'; // Replace with the farmer signup route
        } else if (user.role === 'exporter') {
          url = 'http://localhost:5000/exporterSignup'; // Replace with the exporter signup route
        }
    ...
    return (
        <div className="ui container">
            <div className="ui centered card" style={{ width: '50%' }}>
                        ...
                        <div className="eight wide column">
                            <div className="field">
                                ...
                                <div className="ui left icon input">
                                    <input name="username" value={user.username} type="text" placeholder="Name" onChange={handleInputChange} />
